 ...
 *        tell_mcs                                                           *
 *===========================================================================*/
PUBLIC void tell_mcs(what, p1)
int what;
int p1;
{
/* This routine is only used by PM to inform MCS of certain events:
 *      tell_fs(MCS_TERM, proc)
 *      tell_fs(MCS_UNPAUSE, proc)
 */
  message m;

  m.m_u.m_m1.m1i1 = p1;
  _taskcall(MCS_PROC_NR, what, &m);
}
